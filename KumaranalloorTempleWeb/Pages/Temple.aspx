<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Temple.aspx.cs" Inherits="KumaranalloorTempleWeb.Pages.Temple"
    MasterPageFile="~/Shared/MasterPages/SiteLayout.Master" Title="Temple | Kumaranalloor Devi Temple" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <h1 class="kdt-page-title">TEMPLE</h1>
                </div>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="kdt-content">
                                    <br />
                                    <h5>EARLY HISTORY</h5>
                                    <p>Kumaranalloor is an ancient cultural center. This place was known as ‘thingalkkadu', before the temple . By time the name ‘thingalkkadu' changed and later known as ‘indu kananam'. In some ancient scripts, this temple is described and known as mahishari kovil ( temple ).</p>
                                </div>
                            </div>
                         ...
                         <br />
                            ...
                            <!-- Period of travencore rule -->
                            <div class="col-sm-12">
                                <div class="kdt-content">
                                    <br />
                                    <h5>PERIOD OF TRAVANCORE RULE</h5>
                                    <p>
                ...
                <br />
                            ...
                            <div class="col-sm-12">
                                <div class="kdt-content">
                                    <br />
                                    <h5>POLITICAL & ADMINISTRATIVE SETUP</h5>
                                    <p>
                    ...
                    <div class="container" data-uk-scrollspy="{cls:'uk-animation-scale-up', repeat: false}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="kdt-content">
                                    <br />
                                    <h5>PERUMTHURUTHU SREEKRISHNA SWAMY TEMPLE</h5>
                                    <p>
                                        This temple is in perumthuruth village near kallara. Lord krishna is the main idol and the temple has a rich history. Ashtamirohini, rohini in medam malayala month are the major festival days. Pasting of sandal wood paste and palpayasam are main offerings.                                    </p>
                                </div>
                            </div>
